...
public static class CatalogSeed
{
    ...
    {
        var existing = await context.ReservationStatuses.AsNoTracking().ToListAsync();
        var desired = new[] { "Pendiente", "Confirmada", "Cancelada", "Expirada", "Completada" };
        ...
        foreach (var name in desired)
        {
            ...
            context.ReservationStatuses.Add(new ReservationStatusEntity { Name = name });
        }
