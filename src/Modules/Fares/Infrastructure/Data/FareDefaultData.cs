...
public static class FareDefaultData
{
    ...
    [
        ...
        new() { Id = 16, RouteId = 1, CabinTypeId = 3, PassengerTypeId = 3, SeasonId = 2, BasePrice = 320000.00m, ValidFrom = ValidFrom },
        new() { Id = 17, RouteId = 1, CabinTypeId = 4, PassengerTypeId = 3, SeasonId = 2, BasePrice = 450000.00m, ValidFrom = ValidFrom }
    ];
}
